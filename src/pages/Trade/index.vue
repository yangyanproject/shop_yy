  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeUser(userAddressList, address)">
        ...
        >
          <li>
            <img
              :src="detail.imgUrl"
              alt=""
              style="width: 100pxx; height: 100px"
            />
          </li>
          <li>
            <p>
...
export default {
  ...
  methods: {
    async getTradeInfo() {
      try {
        const result = await this.$API.reqTradeInfo();
        if (result.code === 200) {
    ...
    async getAddressList() {
      try {
        const result = await this.$API.reqUserAddressList();
        if (result.code === 200) {
    ...
    changeUser(userAddressList, address) {
