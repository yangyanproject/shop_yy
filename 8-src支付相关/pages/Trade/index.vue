  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeMo(userAddressList, userAddress)">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="shopList in detailArrayList"
          :key="shopList.skuId"
        >
          <li>
            <img
    ...
    <div class="sub clearFix">
      ...
      <a href="javascript:;" class="subBtn" @click="submitFor">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    this.getTradeInfo(), this.getUserAddress();
  },
  methods: {
    getTradeInfo() {
    ...
    changeMo(userAddressList, userAddress) {
    ...
    async submitFor() {
        ...
        try {
         const result= await this.$API.reqSubmitOrder(tradeNo,tradeInfo)//提交订单生成订单号
